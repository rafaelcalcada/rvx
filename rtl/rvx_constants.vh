...
`define RISCV_FUNCT3_FENCE 3'b000
...
`define RVX_PLIC_PRIORITY0_REG_ADDR 7'h00
`define RVX_PLIC_PRIORITY1_REG_ADDR 7'h04
`define RVX_PLIC_PRIORITY2_REG_ADDR 7'h08
`define RVX_PLIC_PRIORITY3_REG_ADDR 7'h0c
`define RVX_PLIC_PRIORITY4_REG_ADDR 7'h10
`define RVX_PLIC_PRIORITY5_REG_ADDR 7'h14
`define RVX_PLIC_PRIORITY6_REG_ADDR 7'h18
`define RVX_PLIC_PRIORITY7_REG_ADDR 7'h1c
`define RVX_PLIC_PRIORITY8_REG_ADDR 7'h20
`define RVX_PLIC_PRIORITY9_REG_ADDR 7'h24
`define RVX_PLIC_PRIORITY10_REG_ADDR 7'h28
`define RVX_PLIC_PRIORITY11_REG_ADDR 7'h2c
`define RVX_PLIC_PRIORITY12_REG_ADDR 7'h30
`define RVX_PLIC_PRIORITY13_REG_ADDR 7'h34
`define RVX_PLIC_PRIORITY14_REG_ADDR 7'h38
`define RVX_PLIC_PRIORITY15_REG_ADDR 7'h3c
`define RVX_PLIC_ENABLE_REG_ADDR 7'h40
`define RVX_PLIC_PENDING_REG_ADDR 7'h44
`define RVX_PLIC_CLAIM_REG_ADDR 7'h48

// PLIC claim register bit position for the "interrupt pending" valid bit
`define RVX_PLIC_CLAIM_VALID_BIT 4
