...
create_generated_clock -name clkdiv2 -source [get_pins rvx_clock_reg/C] -divide_by 2 [get_pins rvx_clock_reg/Q]
...
set_property PACKAGE_PIN D9 [get_ports push_button_0]
