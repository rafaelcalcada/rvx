...
set memory_init_files {./build/spi_manager_hal_unit_tests.hex}
create_project spi_manager_hal_unit_tests ./spi_manager_hal_unit_tests -part xc7a35ticsg324-1L -force
...
add_files -norecurse { ./spi_manager_hal_unit_tests.v }
