...
create_project rvx_gpio_tests ./rvx_gpio_tests -part xc7a35ticsg324-1L -force
...
add_files -norecurse ../../../tests/testbench/rvx_test_macros.vh
move_files -fileset sim_1 [get_files ../rvx_gpio_tb.v]
move_files -fileset sim_1 [get_files ../../../tests/testbench/rvx_test_macros.vh]
set_property used_in_simulation true [get_files  ../../../rtl/rvx_constants.vh]
set_property used_in_simulation true [get_files  ../../../tests/testbench/rvx_test_macros.vh]
