...
class Log
{
  ...
  template <typename... Targs> static void debug(const char *format, Targs... Fargs)
  {
    get_instance().message(DEBUG, format, Fargs...);
  }

  template <typename... Targs> static void info(const char *format, Targs... Fargs)
  {
    get_instance().message(INFO, format, Fargs...);
  }

  template <typename... Targs> static void warning(const char *format, Targs... Fargs)
  {
    get_instance().message(WARNING, format, Fargs...);
  }

  template <typename... Targs> static void error(const char *format, Targs... Fargs)
  {
    get_instance().message(ERROR, format, Fargs...);
  }

  template <typename... Targs> static void critical(const char *format, Targs... Fargs)
  {
  ...
  template <typename... Targs> void message(Level level, const char *format, Targs... Fargs);

  template <typename... Targs> void message(std::stringstream &ss, const char *format, Targs... Fargs);

  template <typename... Targs> void message(std::stringstream &ss, const char *str)
  {
    ss << str;
  }
};

template <typename... Targs> void Log::message(Level level, const char *format, Targs... Fargs)
{
  if (level >= this->level)
  {
    std::stringstream ss;
...
template <typename... Targs> void Log::message(std::stringstream &ss, const char *format, Targs... Fargs)
{
