...
int main(int argc, char *argv[])
{
  ...
  auto &rw_address = simulator->rootp->rvx_simulator__DOT__rvx_instance__DOT__dbus_controller_address;
  auto &write_request = simulator->rootp->rvx_simulator__DOT__rvx_instance__DOT__dbus_controller_wrequest;
  auto &write_data = simulator->rootp->rvx_simulator__DOT__rvx_instance__DOT__dbus_controller_wdata;
