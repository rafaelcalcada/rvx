...
set memory_init_files {./build/timer_unit_tests.hex}
create_project timer_unit_tests ./timer_unit_tests -part xc7a35ticsg324-1L -force
...
add_files -norecurse { ./timer_unit_tests.v }
