...
if {![file exists "./build/gpio_unit_tests.hex"]} {
  send_msg_id "RVX-001" ERROR "Memory initialization file 'gpio_unit_tests.hex' does not exist. This file needs to be generated to run the unit tests." -continue
  puts "Tip: To generate this file, run 'make' from the tests/gpio/unit_tests directory (from RVX development container)."
  return
}

set memory_init_files {./build/gpio_unit_tests.hex}
create_project gpio_unit_tests ./gpio_unit_tests -part xc7a35ticsg324-1L -force
...
add_files -norecurse { ./gpio_unit_tests.v }
